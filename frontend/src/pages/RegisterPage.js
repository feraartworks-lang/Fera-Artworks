...
import { Mail, Lock, User, Wallet, ArrowLeft, Loader2, Link2, Crown, Gem } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#050505] flex" data-testid="register-page">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          <form onSubmit={handleEmailRegister} className="space-y-5" data-testid="register-form">
            ...
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-[#A3A3A3] text-xs uppercase tracking-wider">
                Confirm Password
              </Label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#525252]" strokeWidth={1.5} />
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <div 
          ...
          style={{ 
            backgroundImage: `url(https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=1920&q=80)`
          }}
        />
        ...
        <div className="absolute bottom-12 left-12 right-12">
          ...
          <p className="text-[#D4AF37] text-sm mt-4 tracking-wider">— Ralph Waldo Emerson</p>
        </div>
      </div>
    </div>
  );
